export default function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-gray-300 h-[15vh] mt-6 relative">
         <div
      ...
      <div className="custom-container mx-auto h-full flex flex-col md:flex-row justify-between items-center text-sm">
        <span className="font-eplilogue font-semibold text-[#b3063a] text-5xl">Movie Explorer</span>
        <span className="mt-2 md:mt-0 text-gray-50 text-center md:text-right font-onset text-xl ">
